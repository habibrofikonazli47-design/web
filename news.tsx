...
<body>
    ...
    <nav class="desktop_navbar">
      ...
      <a href="rank.tsx" class="desktop_navbar_link">rank</a>
    ...
    <div class="mobile_navbar">
      ...
      <div id="mobile_navbar_links">
          ...
          <a class="mobile_navbar_link" onclick="mobile_navbar_link_hider()" href="#join">Join Us</a>
        </div>
    ...
    <div class="mainflex">
      <div class="main1">
        <a class="main1_logo_a" href="#">
          <img class="main1_logo" src="media/update.png" alt="logo">
        </a>
        <div class="main1_description">
          <a>kalian bisa melihat<br>
          <a class="main1_actcent">invo lain di sini</a><a>.</a>
        </div>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-12 gap-6">
        <div>
          <h1 className="text-4xl md:text-5xl text-primary mb-2">🗿SERVER update🗿</h1>
          <p className="font-pixel text-xl text-muted-foreground">Latest updates, patch notes, and events.</p>
        </div>