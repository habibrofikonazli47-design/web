...
<body>
    ...
    <nav class="desktop_navbar">
      ...
      <a href="index.html" class="desktop_navbar_link">home</a>
      <a href="news.tsx" class="desktop_navbar_link">invo update</a>
      <a href="#about" class="desktop_navbar_link">rank</a>
    ...
    <div class="mobile_navbar">
      ...
      <div id="mobile_navbar_links">
          <a class="mobile_navbar_link" onclick="mobile_navbar_link_hider()" href="index.html">home</a>
          <a class="mobile_navbar_link" onclick="mobile_navbar_link_hider()" href="news.tsx">invo update</a>
          <a class="mobile_navbar_link" onclick="mobile_navbar_link_hider()" href="rank.tsx">rank</a>
    ...
    <div class="mainflex">
      <div class="main1">
        <a class="main1_logo_a" href="#">
          <img class="main1_logo" src="media/logo1.png" alt="logo">
        </a>
        <div class="main1_description">
          <a>di sini kami<br>menyediakan</a>
          <a class="main1_actcent">rank untuk kalian beli</a><a>.</a>
        </div>
        <div class="main1_ipcopier_div">
          <button class="main1_ipcopier" onclick="copyText()" type="button">
            <span class="main1_ipcopier_text1">play.viagramc.my.id</span>
            <br>
      ...
      <div id="more"></div>
      <div class="main2">
        <a class="headline">Fitur yang kami berikan</a>
        <div class="main2_features_div">
          <div class="main2_feature">
            <a class="main2_feature_headline">Feature 1</a>
            <a class="main2_feature_text">Deskripsi 1</a>
          </div>
          <div class="main2_feature">
            <a class="main2_feature_headline">Feature 2</a>
            <a class="main2_feature_text">Deskripsi 2</a>
          </div>
          <div class="main2_feature">
            <a class="main2_feature_headline">Feature 3</a>
            <a class="main2_feature_text">Deskripsi 3</a>
          </div>
          <div class="main2_feature">
            <a class="main2_feature_headline">Feature 4</a>
            <a class="main2_feature_text">Deskripsi 4</a>
          </div>
          <div class="main2_feature">
            <a class="main2_feature_headline">Feature 5</a>
            <a class="main2_feature_text">Deskripsi 5</a>
          </div>
        </div>
      </div>
    </div>
    <footer class="copyright_div">
      <a href="https://github.com/FQQD/MCServer-Web-Template" class="copyright">VIAGRAMC 2025 - 2026 BY HABIB</a>
    </footer>
  </body>
</html>
